...
public  class WebactivityTab1 extends AppCompatActivity {
    ...
    private static final String TAG = WebactivityTab1.class.getSimpleName();
                        ...
                        public boolean onMenuItemClick(MenuItem menu_item) {
                            switch (menu_item.getItemId()) {
                                ...
                                case R.id.about:
                                    ...
                                    Toast.makeText(WebactivityTab1.this, "Owl Browser Version "+versionName+" Uses free icons from freepik.com", Toast.LENGTH_SHORT).show();

                                    //Do your action here
                                    break;
                                case R.id.clrcache:
                                    webl.clearCache(true);
                                    Toast.makeText(WebactivityTab1.this, "Cache cleared", Toast.LENGTH_SHORT).show();
                        ...
                        public boolean onMenuItemClick(MenuItem menu_item) {
                            switch (menu_item.getItemId()) {
                                case R.id.tab1:
                                    ...
                                    Toast.makeText(WebactivityTab1.this, "Tab 1 is Already Active!", Toast.LENGTH_SHORT).show();
                                    //Do your action here
                                ...
                                case R.id.tab2:
                                    ...
                                    Intent in = new Intent(WebactivityTab1.this, WebactivityTab2.class);
                                    startActivity(in);
                                ...
                                case R.id.home:
                                    ...
                                    Intent ind = new Intent(WebactivityTab1.this, Webactivity.class);
                                    startActivity(ind);
                                    overridePendingTransition(R.anim.trs, R.anim.fade);
                                    //Do your action here
                                    break;
...
//                                   });
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(WebactivityTab1.this, MainActivity.class);
                webl.clearCache(true);
                startActivity(i);
        ...
        final FrameLayout flayout = findViewById(R.id.framlytt);
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.startsWith("whatsapp://")) {
                    ...
                    try {
                        ...
                        String MakeShortText = "Whatsapp not  installed";
...
// Start the animation
        ...
        final TextView txtinfo = (TextView) findViewById(R.id.infotext);
        webl.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.setType("*/*");
                WebactivityTab1.this.startActivityForResult(Intent.createChooser(i, "File Browser"),
            ...
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(WebactivityTab1.this.getPackageManager()) != null) {
                    File photoFile = null;
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.addbookmark) {
            ...
            Toast.makeText(WebactivityTab1.this, message, Toast.LENGTH_SHORT).show();


        } else if (id == R.id.bookmarks) {

            Intent i = new Intent(WebactivityTab1.this,BookmarkActivity.class);
            startActivity(i);
            ...
            Intent i =new Intent(WebactivityTab1.this,HistoryList.class);
            startActivity(i);
    ...
    public boolean isStoragePermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                ActivityCompat.requestPermissions(WebactivityTab1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                return false;
            }
    ...
    public void Downloader(String url, String userAgent, String contentDisposition, String mimeType, long contentLength){
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (isStoragePermissionGranted()) {
                ...
                Toast.makeText(WebactivityTab1.this, "Grant storage permission", Toast.LENGTH_SHORT).show();
            }
        } else {
