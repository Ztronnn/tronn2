...
public class Webactivity extends AppCompatActivity {
    ...
    public static final String HISTORYPREFERENCES = "HISTORY";
    public static final String PREFERENCES = "PREFERENCES_NAME";
    public static final String WEB_LINKS = "links";
    public static final String WEB_TITLE = "title";

    public static final String HISTORY_LINKS = "hlinks";
    public static final String HISTORY_TITLE = "htitle";
                        ...
                        public boolean onMenuItemClick(MenuItem menu_item) {
                            ...
                            switch (menu_item.getItemId()) {
                                ...
                                case R.id.clrcache:
                                    ...
                                    Toast.makeText(Webactivity.this, "Cache cleared", Toast.LENGTH_SHORT).show();
                                ...
                                case R.id.about:
                                    ...
                                    Toast.makeText(Webactivity.this, "Owl Browser Version "+versionName+" Uses free icons from freepik.com", Toast.LENGTH_SHORT).show();
                                                   ...
                                                   public boolean onMenuItemClick(MenuItem menu_item) {
                                                       ...
                                                       overridePendingTransition(R.anim.fade, R.anim.trs);
                                                           ...
                                                           case R.id.tab2:
                                                               ...
                                                               Intent in = new Intent(Webactivity.this, WebactivityTab2.class);
                                                       startActivity(in);
                                                       overridePendingTransition(R.anim.trs, R.anim.fade);
                                                           ...
                                                           case R.id.home:
                                                               ...
                                                               Toast.makeText(Webactivity.this, "Home Tab Active", Toast.LENGTH_SHORT).show();
                                                               //Do your action here
                                                               break;
...
//                    WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        webl.getSettings().setSupportMultipleWindows(true);
        ...
        if (Build.VERSION.SDK_INT < 18) {
            ...
            webl.getSettings().setAppCacheMaxSize(5* 1024 * 1024);  // 5 MB
        }
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith("whatsapp://")) {
                        ...
                        try {
                            ...
                            Toast.makeText(Webactivity.this, MakeShortText, Toast.LENGTH_SHORT).show();
                        }
...
// Start the animation
        ...
        loadingProgressBar = findViewById(R.id.prog);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.addbookmark) {
            ...
            Intent i = new Intent(Webactivity.this, BookmarkActivity.class);
            startActivity(i);


        } else if (id == R.id.history) {

            Intent i = new Intent(Webactivity.this, HistoryList.class);
            startActivity(i);
...
//
    ...
    public void saveHistory() {
        ...
        mergedList.addAll(hlinkList);
        mergedList.addAll(htitleList);
...
//                String str = hlinkList.get(i) + "," + htitleList.get(i);
//                // if list2 contains integers
//                String str = hlinkList.get(i) + "," + String.valueOf(htitleList.get(i));
//                list3.add(str);
//            }


        String[] ProgLanguages = {"google.com", "yahoo.com", "", ".Net", "PHP", "Perl",
                "Objective-c", "Small-Talk", "C#", "Ruby", "ASP", "ASP .NET"};
        autoTextView = findViewById(R.id.urlbox2);
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(this,
                R.layout.url_listview, mergedList);
    ...
    public void Downloader(String url, String userAgent, String contentDisposition, String mimeType, long contentLength){
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (isStoragePermissionGranted()) {
                ...
                Toast.makeText(Webactivity.this, "Grant storage permission", Toast.LENGTH_SHORT).show();
            }
        } else {
